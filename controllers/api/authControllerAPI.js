const bcrypt = require('bcrypt');//Para comparar passwords
const jwt = require('jsonwebtoken');// Para los token
const Usuario = require('../../models/usuario');//Preferencial al ususrio porque lo vamos a ir a buscar
